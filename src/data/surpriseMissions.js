...
export const SURPRISE_CATEGORIES = [
  ...
  { id: 'mindset',    label: 'מיינדסט',    emoji: '🧠', defaultOn: true  },
...
const MISSIONS = {
  fitness: [
    ...
    { id: 'fitness_4',  text: 'תרגל 10 דקות shadow boxing מול מראה — קצב + תנועה' },
    ...
    { id: 'fitness_8',  text: 'תרגל 5 דקות תנועות מואי תאי בסיסיות: jab, cross, kick' },
  ...
  social: [
    ...
    { id: 'social_13', text: 'כתוב review אמיתי לעסק קטן שאהבת — עם פרטים ספציפיים' },
  ...
  mindset: [
    ...
    { id: 'mindset_3',  text: 'כתוב על הפחד שהכי מעכב אותך כרגע — ואז כתוב מה ה-worst case האמיתי' },
    ...
    { id: 'mindset_7',  text: 'עשה 5 דקות body scan: שב בשקט, סרוק מהראש לכפות הרגליים, שים לב בלי לשנות' },
    ...
    { id: 'mindset_13', text: 'עשה visualization של 5 דקות: דמיין את היום המושלם שלך בעוד שנה — בפרטים חושיים' },
  ...
  community: [
    ...
    { id: 'community_9',  text: 'כתוב review של 5 כוכבים לעסק קטן שממש אהבת — עם פירוט ספציפי' },
  ...
  adventure: [
    { id: 'adventure_1',  text: 'לך למסעדה שמעולם לא ניסית — הזמן ללא reviews, בטן גוברת' },
...
export const REPEATABLE_MISSIONS = {
  ...
  fitness_4:   { pillar: 'body',       suggestedHabitTitleHe: 'shadow boxing 10 דקות',   suggestedTriggerHe: 'אחרי ארוחת הבוקר' },
  ...
  mindset_7:   { pillar: 'discipline', suggestedHabitTitleHe: 'body scan 5 דקות',        suggestedTriggerHe: 'כשאני מתעורר' },
  ...
  community_9: { pillar: 'people',     suggestedHabitTitleHe: 'כתוב review לעסק טוב',    suggestedTriggerHe: 'אחרי ביקור' },
